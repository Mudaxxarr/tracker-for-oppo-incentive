        ...
        <Card>
          <CardContent className="space-y-6 pt-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <TextField disabled={pending} id="businessName" label="Dealer/business name" placeholder="Al-Hassan Electronics" error={state.fieldErrors?.businessName} />
              <TextField disabled={pending} id="ownerName" label="Owner name" placeholder="Muhammad Ali" error={state.fieldErrors?.ownerName} />
              <TextField disabled={pending} id="ownerEmail" label="Email" type="email" placeholder="owner@example.com" error={state.fieldErrors?.ownerEmail} />
              <TextField disabled={pending} id="mobileNumber" label="Mobile number" placeholder="03xxxxxxxxx" error={state.fieldErrors?.mobileNumber} />
              <TextField disabled={pending} id="whatsappNumber" label="WhatsApp number" placeholder="03xxxxxxxxx" error={state.fieldErrors?.whatsappNumber} />
              <TextField disabled={pending} id="cityRegion" label="City/region" placeholder="Lahore" error={state.fieldErrors?.cityRegion} />
              <TextField disabled={pending} id="oppoDealerId" label="OPPO dealer ID" placeholder="DLR-00123" error={state.fieldErrors?.oppoDealerId} />
              <TextField disabled={pending} id="staffCount" label="Number of staff who will use the app" type="number" min={0} max={50} defaultValue={1} error={state.fieldErrors?.staffCount} />
