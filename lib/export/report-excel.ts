...
export async function buildExcel(
  ...
  summary.addRows([
    ...
    { k: "Dealer Incentive eligible", v: report.dealerIncentives.some((d) => d.eligible) ? "Yes" : "No" },
    { k: "Dealer Incentive policies met", v: `${report.dealerIncentives.filter((d) => d.eligible).length} / ${report.dealerIncentives.length}` },
